...
This repository now contains the first real scaffold behind that design: a host-runnable kernel prototype, a Zig build, a Fortran policy module, architecture stubs, and docs that map the design into code.
...
- Zig to Fortran linking in the main build graph
